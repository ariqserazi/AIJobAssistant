#!/usr/bin/env python3
"""
sync_email_responses_to_sheet.py - Dynamically scour ariq.serazi1@gmail.com for job responses 
(Rejections, Interviews, Assessments, Offers) and sync corresponding statuses to Ariq's Google Sheet.
"""
